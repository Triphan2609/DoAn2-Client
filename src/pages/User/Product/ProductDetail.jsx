                        ...
                        <div className="row ant-image-and-info-product">
                            <div className="col-xl-6 col-lg-6 col-md-12 col-12 ant-mobile-padding">
                                ...
                                >
                                    {product &&
                                        product.image_url &&
                                        JSON.parse(product.image_url).map(
                                            (item, index) => {
                                                return (
                                                    <div key={index}>
                                                        <h3
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-12 col-12 details-pro">
                                <div className="ant-info-product">
                                    ...
                                    <div className="summary">
                                        <p>
                                            Mua hàng <strong>ONLINE</strong>:
                                            Quý khách chỉ cần Click vào nút
                                            <strong> MUA HÀNG </strong>
                                            Hoặc gọi hay nhắn tin tới 0398944226
                                            để mua hàng
                                        </p>
                                    </div>
                    ...
                    <div className="ant-product-tab">
                        ...
                        <div className="tab-content" id="myTabContent">
                            ...
                            >
                                ...
                                <p>
                                    <strong>
                                        Quý khách có thể đổi hàng đã mua trong
                                        các trường hợp sau:
                                    </strong>
                                </p>
                                <ul>
                                    <li>
                                        Hàng có lỗi kỹ thuật do nhà sản xuất,
                                    </li>
                                    <li>Hàng bị giao nhầm, nhầm size.</li>
                                </ul>
                                <p>
                                    Thời hạn đổi hàng : 05 ngày kể từ ngày
                                    mua/nhận hàng
                                </p>
                                <p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Hàng đổi phải có giá bằng hoặc cao hơn
                                        hàng đã mua
                                    </li>
                                </ul>
                                <p>
                                ...
                                <ul>
                                    <li>
                                        Nếu hàng bị lỗi kỹ thuật do nhà sản
                                        xuất: miễn phí toàn bộ phí chuyển hàng
                                        (gửi trả và giao hàng)
                                    </li>
                                    <li>
                                        Trường hợp khác Quý khách hàng sẽ chịu
                                        chi phí&nbsp;chuyển hàng (gửi trả và
                                        giao hàng).
                                    </li>
                                </ul>
                                <p>
                                    ...
                                    <br />
                                    62/4 Trần Bình Trọng, Phường 8, TP. Vũng
                                    Tàu.
                                    <br />
                                ...
                                <p>
                                    <em>
                                        Xin Quý Khách Hàng lưu ý: Chúng tôi
                                        không hỗ trợ Quý khách trả lại hàng.
                                    </em>
                                </p>
                                <p>
                                    <u>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Thời hạn bảo hành dây kéo&nbsp;: trọn
                                        đời.
                                    </li>
                                </ul>
                                <p>
                                ...
                                <p>
                                    <strong>
                                        Chân thành cảm ơn Quý Khách Hàng đã quan
                                        tâm đến các sản phẩm nhãn hiệu Pet Shop.
                                    </strong>
                                </p>
                            </div>
                            ...
                            >
                                <p>
                                    <span style={{ color: "#c0392b" }}>
                                        ...
                                        <strong>
                                            <em>
                                                - Để được bền màu sản phẩm
                                                Petshop hàng 100% cotton không
                                                nên dùng xà bông(xà phòng), nước
                                                giặt có chất tẩy.&nbsp;
                                                <br />- Nên phơi trong bóng râm,
                                                tránh phơi sản phẩm&nbsp;ra nơi
